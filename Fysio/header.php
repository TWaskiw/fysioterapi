...
<nav>
    ...
    <?php 
        if(isset($_SESSION['number'])) {
            echo "<li class='navlogo'><a href='#'><span>Mark</span>Skals</a></li>";
            echo "<li class='item'><a href='#'>Behandlinger</a></li>";
            echo "<li class='item'><a href='#'>Om mig</a></li>";
            echo "<li class='item'><a href='#'>Kontakt</a></li>";
